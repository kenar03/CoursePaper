///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V9.30.1.335/W64 for ARM        29/Mar/2025  15:24:00
// Copyright 1999-2022 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =
//        C:\Users\@@@@\Documents\@@4\proj123\RtosWrapper\MyTasks\myfirsttask.cpp
//    Command line =
//        -f
//        C:\Users\@@@@\Documents\@@4\proj123\RtosWrapper\Debug\Obj\MyTasks\myfirsttask.o.rsp
//        (C:\Users\@@@@\Documents\@@4\proj123\RtosWrapper\MyTasks\myfirsttask.cpp
//        -lC
...
//        C:\Users\@@@@\Documents\@@4\proj123\RtosWrapper\Debug\Obj\MyTasks\myfirsttask.o.d
//    Locale       =  C
//    List file    =
//        C:\Users\@@@@\Documents\@@4\proj123\RtosWrapper\Debug\List\MyTasks\myfirsttask.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC _ZN11MyFirstTask7ExecuteEv
...
// C:\Users\@@@@\Documents\@@4\proj123\RtosWrapper\MyTasks\myfirsttask.cpp
//    1 #include "myfirsttask.h" // for class definition
...
//    2 #include <iostream> // for std::cout
        ...
        SECTION `.text`:CODE:NOROOT(2)
          ...
          CFI Function _ZN11MyFirstTask7ExecuteEv
        THUMB
//    3 void MyFirstTask::Execute()
//    4 {
_ZN11MyFirstTask7ExecuteEv:
        PUSH     {R7,LR}        
          CFI R14 Frame(CFA, -4)
          CFI CFA R13+8
//    5   for(;;)
...
//   11 }
        ...
        SECTION `.iar_vfe_vtableinfo_ZTV11MyFirstTask`:DATA:NOALLOC:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, 0
        SECTION_GROUP _ZTV11MyFirstTask
        DATA
        DC32    _ZTV11MyFirstTask
        DC32    3
        DC32    3
        DC32    _ZTI11MyFirstTask
        DC32    1
        DC32    2
        DC32    0
...
_ZTVSt11_Wrap_facetISt5ctypeIcEE:
        ...
        SECTION_GROUP _ZTV11MyFirstTask
        DATA
// __absolute void (*const MyFirstTask::__vtbl[3])()
_ZTV11MyFirstTask:
        DATA32
        DC32 0x0, _ZTI11MyFirstTask, _ZN11MyFirstTask7ExecuteEv

        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        SECTION_GROUP _ZTI11MyFirstTask
        DATA
// __absolute __si_class_type_info const <Typeinfo for MyFirstTask>
_ZTI11MyFirstTask:
        DATA32
        DC32 _ZTVN10__cxxabiv120__si_class_type_infoE + 0x8, _ZTS11MyFirstTask
        DC32 _ZTIN9OsWrapper6ThreadILj2048EEE
...
_ZTSN9OsWrapper6ThreadILj2048EEE:
        ...
        SECTION `.rodata`:CONST:REORDER:NOROOT(2)
        SECTION_GROUP _ZTS11MyFirstTask
        DATA
// __absolute char const <Typeinfo name for MyFirstTask>[14]
_ZTS11MyFirstTask:
        DATA8
        DC8 "11MyFirstTask"
        DATA16
...
// 
// 44 bytes of CODE  memory (+ 1'630 bytes shared)
// 16 bytes of CONST memory (+   312 bytes shared)
